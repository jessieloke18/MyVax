...
<div class="container signup-container">
  ...
  <div class="row">
    <div class="col-md-7 col-lg-5 signup-form-column">
      ...
      <!--admin form-->
      <form class="signup-form-admin" action="signupAdmin.php" method="POST">
        <div class="form-check form-check-inline py-3">
          <input class="form-check-input" type="radio" name="radioCentre" id="existingCentre" value="existingCentre" checked onclick=selectCentre() <?php if (isset($_POST['radioCentre']) && $_POST['radioCentre'] == 'existingCentre')  echo ' checked="checked"'; ?>>
          <label class="form-check-label" for="existingCentre">Existing Centre</label>
        </div>
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="radio" name="radioCentre" id="newCentre" value="newCentre" onclick=selectCentre() <?php if (isset($_POST['radioCentre']) && $_POST['radioCentre'] == 'newCentre')  echo ' checked="checked"'; ?>>
